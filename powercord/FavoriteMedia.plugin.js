 ...
 * @version 1.6.42
 * @source https://github.com/0x03c/FavoriteMedia/tree/main/powercord
 */
...
module.exports = (() => {
	const config = {
		info: {
			...
			description: "Allows to favorite images, videos and audios. Adds tabs to the emojis menu to see your favorited medias.",
			version: "1.6.42",
			github: "https://github.com/0x03c/FavoriteMedia/tree/main/powercord",
			github_raw: "https://raw.githubusercontent.com/0x03c/FavoriteMedia/main/powercord/FavoriteMedia.plugin.js"
		},
		defaultConfig: [
			{
				type: "switch",
			...
			return class FavoriteMedia extends Plugin {
				...
				onStart() {
					PluginUpdater.checkForUpdate(
						this.getName(),
						this.getVersion(),
						"https://raw.githubusercontent.com/0x03c/FavoriteMedia/main/powercord/FavoriteMedia.plugin.js"
					);
